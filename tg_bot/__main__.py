...
def send_start(bot, update):
    ...
    keyboard += [[InlineKeyboardButton(text="💠Add Me💠",url="http://t.me/zoldycktmbot?startgroup=true"),InlineKeyboardButton(text="♻️Owner",url="https://telegram.dog/berlinhere")]]
